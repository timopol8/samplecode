...
//                }
        ...
        if (!stack.isEmpty()) {
            throw new ParenthesesException("", ParenthesesException.TOO_FEW_CLOSING_PARENTHESES);
        }
